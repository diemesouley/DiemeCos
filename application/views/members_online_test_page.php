...
GROUP BY d.`DIS_NAME` ASC");
...

                                            {
                                                ...
                                                y: <?=$rowdis->totins;?>,
                                                url: '<?= base_url();?>index.php/institutes/institute_list_graph/<?php echo $rowdis->DIS_ID; ?>/<?php echo $rowlevel2->SchoolLevelId?>'
                                            },
...
GROUP BY d.`DIV_ID`,d.`DIV_NAME`,d.`DIS_ID`,d.`DIS_NAME`");
...

                                            {
                                                ...
                                                y: <?=$rowdisnew->total;?>,
                                                url: '<?= base_url();?>index.php/institutes/getdivisionwiseschools/<?php echo $rowdisnew->DIS_ID; ?>/<?= $rowdisnew->DIV_ID?>'
                                            },
...
GROUP BY d.`DIS_ID`,d.`DIS_NAME`,d.`SchoolLevelId`,d.`SchoolLevel`");
...

                                            {
                                                ...
                                                y: <?=$rowdisemps->total;?>,
                                                url: '<?= base_url();?>index.php/dashboard/getDistrict_employees/<?php echo $rowsforemp->SchoolLevelId; ?>/<?php echo $rowdisemps->DIS_ID?>'
                                            },
...
ORDER BY s.`SchoolLevelId` DESC");
...

                                            {
                                                ...
                                                y: <?=$rowdis_stds->tot;?>,
                                                url: '<?= base_url();?>index.php/dashboard/get_students/<?php echo $rowsforlevels->SchoolLevelId; ?>/<?php echo $rowdis_stds->dis_id?>'
                                            },
