...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="<?=base_url()?>dashboard" class="logo">
            ...
            <span class="logo-mini"><b>G</b>GesCos</span>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="<?=base_url()?>assets/dist/img/souley.jpg" class="user-image" alt="User Image">
                            <span class="hidden-xs"><?=$this->session->userdata('employee');?></span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- User image -->
                            <li class="user-header">
                                <img src="<?=base_url()?>assets/dist/img/souley.jpg" class="img-circle" alt="User Image">
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="<?=base_url('index.php/users/change_password')?>" class="btn btn-default btn-flat">Changer mot passe</a>
                                </div>
                                <div class="pull-right">
                                    <a href="<?=base_url('index.php/users/logout')?>" class="btn btn-default btn-flat">Déconnexion</a>
                                </div>
                            </li>
                        </ul>
                    </li>
