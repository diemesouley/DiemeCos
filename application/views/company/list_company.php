            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class='form-group'>
                        <label for='inputEmail1' class='col-lg-3 col-sm-3 control-label'>Nom de l'Entreprise
                        </label>
                        <div class='col-lg-9'>
                    ...
                    <div class='form-group'>
                        <label for='inputPassword1' class='col-lg-3 col-sm-3 control-label'>N° Tel</label>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class='form-group'>
                    <label for='inputEmail1' class='col-lg-3 col-sm-3 control-label'>Nom de 
                        l'Entreprise</label>
                    <div class='col-lg-9'>
