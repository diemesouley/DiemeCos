                ...
                <div class="adv-table table-responsive">
                    <table class="display table table-bordered table-striped" id="dynamic-table">
                        ...
                        <tr>
                            <th>ID Du CLIENT</th>
                            <th>NOM DU CLIENT</th>
                            <th>CELLULE DU CLIENT</th>
                            <th class="hidden-phone">ADRESSE DU CLIENT</th>
                            <th>ANCIEN N° DU CLIENT</th>
                        ...
                        <div class="modal-body">
                            ...
                            <form id="CustomerForm" class="form-horizontal" method="post">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="CustomerNameInput" placeholder="Nom du Client" name="cname" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="CustomerAddressInput" placeholder="Adresse" name="caddr" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="CustomerContactNumberInput" placeholder="N° Contact" maxlength="11" name="cno" required>
