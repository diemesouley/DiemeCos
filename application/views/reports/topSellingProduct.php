                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12 col-md-offset-3">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label class="control-label">Date Début<span class="required" aria-required="true"> *</span></label>

                                    <div class="input-group">
                                        <input type="text" value="" class="form-control datepicker" id="start_date" name="start_date" data-format="dd/mm/yyyy" required="" aria-required="true">
                                ...
                                <div class="form-group">
                                    <label class="control-label">Date Fin<span class="required" aria-required="true"> *</span></label>
                                    <div class="input-group">
                                        <input type="text" value="" class="form-control datepicker" id="end_date" name="end_date" data-format="dd/mm/yyyy" required="" aria-required="true">
                                ...
                                <button type="submit" class="btn bg-navy">Generer Rapport</button><br><br>
                            </div>
                            <!-- /.box-body -->
                ...
                <div id="printableArea">
                    ...
                    <div class="row ">
                        <div class="col-md-8 col-md-offset-2">
                            ...
                            <span><strong>Date Début:</strong> 01 Oct 2016 <strong>Date Fin:</strong> 12 Oct 2016</span>
                                ...
                                <div class="table-responsive">
                                    <table width="100%" class="table table-bordered" border="0" cellspacing="0" cellpadding="5">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">Fcfa 200.00</td>
                                            <td class="text-right">Ffac 300.00</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">2</td>
                                            <td class="text-right">Fcfa 1600.00</td>
                                            <td class="text-right">Fcfa 1850.00</td>
                                            <!--                                            <td class="text-right">--><!--</td>-->
                                            <!--                                            <td class="text-right">--><!--</td>-->
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="text-right">Fcfa 4500.00</td>
                                            <td class="text-right">Fcfa 5000.00</td>
                                            <!--                                            <td class="text-right">--><!--</td>-->
                                            <!--                                            <td class="text-right">--><!--</td>-->
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="text-right">1</td>
                                            <td class="text-right">Fcfa 250.00</td>
                                            <td class="text-right">Fcfa 290.00</td>
                                            <!--                                            <td class="text-right">--><!--</td>-->
                                            <!--                                            <td class="text-right">--><!--</td>-->
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="text-right">1</td>
                                            <td class="text-right">Fcfa 2399.00</td>
                                            <td class="text-right">Fcfa 3500.00</td>
                                            <!--                                            <td class="text-right">--><!--</td>-->
                                            <!--                                            <td class="text-right">--><!--</td>-->
                                        </tr>
                                        </tbody></table>
