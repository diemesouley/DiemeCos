        ...
        <div class="box box-primary">
            <div class="box-header box-header-background with-border">
                <div class="col-md-offset-3">
                    <h3 class="box-title ">Rapport Paiement Du:</h3>
                </div>
            </div>
            <!-- /.box-header -->
                        ...
                        <div class="col-md-4 col-sm-12 col-xs-12 col-md-offset-3">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label class="control-label">Date Début<span class="required"> *</span></label>

                                    <div class="input-group">
                                        <input type="text" value="" class="form-control datepicker" name="start_date" data-format="dd/mm/yyyy" required="">
                                ...
                                <div class="form-group">
                                    <label class="control-label">Date Fin<span class="required"> *</span></label>
                                    <div class="input-group">
                                        <input type="text" value="" class="form-control datepicker" name="end_date" data-format="dd/mm/yyyy" required="">
