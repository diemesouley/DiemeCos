            ...
            <div class="panel-body">
                <div class="box">
                    <div class="box-header">
                        <h2 class="blue"><i class="fa-fw fa fa-bars"></i>Profit / Perte</h2>

                        <div class="box-icon">
                            <div class="form-group choose-date hidden-xs">
                                <div class="controls">
                                    <form action="<?=base_url();?>index.php/dashboard/profitLoss" method="post">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="col-sm-4">
                                            <div class="small-box padding1010 borange">
                                                ...
                                                <p><?= $tot_pur->total;?> Achats &amp; <?= $tot_pur->purchases;?> Payé &amp; <?php echo $tot_pur->p_discount?> % Discount</p>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="small-box padding1010 bdarkGreen">
                                                ...
                                                <p><?= $tot_sales->total;?> Ventes &amp; <?= $tot_sales->sales;?> Payé &amp; <?php echo $tot_sales->p_discount?> % Discount</p>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="small-box padding1010 bred">
                                                <h4 class="bold">Profit / Perte</h4>
